...
public:
	Application() : GameObject(__FUNCTION__), m_shader(0) {
		...
		// use your data
		m_texture = new Texture(y, x, n, data1);
		...
		m_gameObjects.push_back(new GameObject("kamk-logo.png"));
		m_gameObjects.push_back(new GameObject("kamk-logo.png"));

		m_gameObjects[0]->setScaling(glm::vec3(130, 130, 0));
		m_gameObjects[1]->setScaling(glm::vec3(130, 130, 0));

		m_gameObjects[0]->setPosition(glm::vec3(100, 0, 0));
		m_gameObjects[1]->setPosition(glm::vec3(-100, 0, 0));
	...
	void render(GLFWwindow* window) {
		...
		for( auto it : m_gameObjects)
		{
			m_spriteBatch->render(m_shader, m_texture->getTextureId());
		}
